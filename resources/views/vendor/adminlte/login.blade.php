...
@section('body')
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ route('welcome') }}">{!! config('adminlte.logo', '<b>Admin</b>LTE') !!}</a>
        </div>
        <div class="card">
            <div class="card-body login-card-body">
                <p class="text-center m-0">{{ __('adminlte::adminlte.login_message') }}</p>
                <form class="my-4" action="{{ $login_url }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-8 align-self-center">
                            <div class="icheck-primary">
                                ...
                                <label class="m-0" for="remember">{{ __('adminlte::adminlte.remember_me') }}</label>
                            </div>
                        </div>
                        <div class="col-4">
