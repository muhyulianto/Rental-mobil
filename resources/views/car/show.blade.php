    ...
    <div class="card-body">
        <div class="row align-items-center">
            <div class="col-lg-6 text-center">
                <img src="{{ asset('storage/images/'.$car->image) }}" alt="No image" class="img-fluid" style="max-height: 400px; object-fit: cover">
            </div>
            <div class="col-lg-6">
                <div class="d-flex justify-content-center">
                    <table class="table w-75">
                        <tr>
                            <td class="text-muted border-top-0">Type</td>
